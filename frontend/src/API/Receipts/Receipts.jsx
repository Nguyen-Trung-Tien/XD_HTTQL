...
const API_URL = `${import.meta.env.VITE_API_URL}/api/v1/import-receipt`;
...
export const updateImportReceipt = async (id, data) => {
  const res = await axios.put(`${API_URL}/update/${id}`, data);
  return res.data;
};

export const deleteImportReceipt = async (id) => {
