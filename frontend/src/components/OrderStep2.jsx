      ...
      setOrderData({
        ...
        shipping: {
          ...
          ...(selectedAddress.address && {
            city: selectedAddress.address.city || selectedAddress.address.town || '',
      ...
      <div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input type="hidden" name="lat" value={orderData.shipping.lat || ''} />
                <input type="hidden" name="lng" value={orderData.shipping.lng || ''} />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-between">
          ...
          <button
            ...
            disabled={!orderData.customer.name || !orderData.customer.phone || !orderData.shipping.address}
            className={`px-6 py-2 gradient-bg text-white rounded-lg font-semibold hover:opacity-90 transition-opacity shadow-sm ${
              !orderData.customer.name || !orderData.customer.phone || !orderData.shipping.address
