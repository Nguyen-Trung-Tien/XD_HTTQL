        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-2 mb-4">
          ...
          <div className="flex gap-2 flex-wrap">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 text-white rounded bg-gradient-to-r from-[#00BFFF] to-[#87CEFA] hover:opacity-90"
            >
              <FiPlus /> Thêm nhà cung cấp
            </button>
            <button
              onClick={() => alert("Đang phát triển")}
              className="px-4 py-2 rounded text-white bg-gradient-to-r from-[#00BFFF] to-[#87CEFA] hover:opacity-90"
            >
              Nhập hóa đơn
            </button>
            <button
                  ...
                  <tr key={supplier.id}>
                    ...
                    <td className="p-2 border flex gap-2 justify-center">
                      <button
                        ...
                        className="p-2 rounded text-white bg-gradient-to-r from-[#00BFFF] to-[#87CEFA]"
                      >
                        <FiEdit />
                      </button>
                      <button
            ...
            <div className="bg-white p-6 rounded shadow-lg w-full max-w-md">
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <div className="flex justify-end gap-2 mt-4">
                  ...
                  <button
                    type="submit"
                    className="px-4 py-2 rounded text-white bg-gradient-to-r from-[#00BFFF] to-[#87CEFA]"
                  >
